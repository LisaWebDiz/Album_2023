...
class Album(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Автор альбома')
...
class Photo(models.Model):
    image_file = models.FileField(upload_to='image/%Y/%m/%d', validators=[image_validator], verbose_name='Фотография')
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Автор альбома', related_name='user_photos')
